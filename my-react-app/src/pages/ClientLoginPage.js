        ...
        <div className="login-page">
            <div className="login-container">
                ...
                <div className="info-section">
                    ...
                    <p>Sign in to access your personalized dashboard and continue your hiring journey.</p>
                    ...
                    <div className="benefits-list">
                        <div className="benefit-item">
                            ...
                            <div className="benefit-content">
                                <h4>Continue Your Projects</h4>
                                <p>Manage ongoing projects and track freelancer progress</p>
                            </div>
                        </div>
                        ...
                        <div className="benefit-item">
                            ...
                            <div className="benefit-content">
                                ...
                                <p>Access detailed insights about your hiring activities</p>
                            </div>
                        </div>
                        ...
                        <div className="benefit-item">
                            ...
                            <div className="benefit-content">
                                <h4>Quick Actions</h4>
                                <p>Post new jobs and communicate with freelancers instantly</p>
                            </div>
                        </div>
                    </div>
...
const handleSubmit = async (e) => {
    ...
    // 1. Run local UI validation (checks for empty email/password)
    const formErrors = validateForm();
    if (Object.keys(formErrors).length > 0) {
        setErrors(formErrors);
        return;
    ...
    try {
        // 2. Call the general Login endpoint
        ...
        if (response.ok) {
            // 3. On Success: Save JWT and Role, then redirect to Dashboard
            localStorage.setItem('token', data.token);
            localStorage.setItem('userRole', data.role);

            console.log('Client login successful');

            // Redirect to the client-specific dashboard
            navigate('/client-dashboard');
        } else {
            // 4. Handle logical errors (e.g. "Invalid credentials")
            // data.message comes from our GlobalExceptionHandler.java
